...
//   final String title;
//   final String date;          // e.g. "22 August 2025"
//   final String time;          // e.g. "06:00 PM IST"
//   final String speaker;       // e.g. "Rushikesh Meharwade"
//   final String role;          // e.g. "Founder, Vidvatta"
//   final String buttonText;
//   final String bannerAsset;   // e.g. "assets/images/50%3d.jpg"
//   final String? speakerAvatar; // optional network asset
//
...
//     final bannerHeight = isTablet ? 180.0 : 150.0;
//     final radius = 18.0;
//
...
//             colors: isDark
//                 ? [const Color(0xFF10141A), const Color(0xFF151A20)]
...
//                         ),
//                       if (isLive && isUpcoming) const SizedBox(width: 8),
//                       if (isUpcoming)
//                         _ChipBadge(
//                           label: "UPCOMING",
...
//     final pad = widget.dense ? const EdgeInsets.symmetric(horizontal: 18, vertical: 10)
...
//               ),
//               const SizedBox(width: 8),
//                 Icon(Icons.arrow_forward_rounded, size: 18,color: AppColors.background,),
//             ],
//           ),
//         ),
//       ),
